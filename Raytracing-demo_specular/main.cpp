...
//    lights.push_back(&l1);
    ...
    Camera camera(Vector(0, 0, 0), Vector::FORWARD);
...
int main(int argc, char* argv[])
{
    ...
    Sphere s1(Vector(500, 500, 300), 125.0, Color::GREEN);
    Sphere s2(Vector(500, 500, 600), 100.0, Color::RED);
    ...
    std::vector<Light*> lights;
    DirectionalLight l1(-Vector::UP, 0.75);
    PointLight pl1(Vector::RIGHT * 100, 20000);
//    lights.push_back(&l1);
    lights.push_back(&pl1);

    Camera camera(Vector(0, 0, 0), Vector(0.0, 1.0, 0.0).unit());
