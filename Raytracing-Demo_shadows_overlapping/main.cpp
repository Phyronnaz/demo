...
int main(int argc, char* argv[])
{
    ...
    Sphere s1(Vector(800, 200, 300), 100.0, Color::GREEN);
    Sphere s2(Vector(500, 200, 300), 100.0, Color::RED);

    Plane p1(Vector(0, 0, 0), Vector::RIGHT, Vector(0,1,0.5), Color::BLUE);
    ...
    PointLight pl1(Vector(-100,0,500), 5e6);
//    lights.push_back(&l1);
